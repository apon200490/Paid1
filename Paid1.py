...
def approval():
  ...
  try:
    httpCaht = get_response('https://github.com/apon200490/APROVAL.txt/blob/main/APROVAL.txt')
    if realid in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('xdg-open https://wa.me/message/01643537105'+tks)
      sys.exit()
      #time.sleep(1)
      #approval()
